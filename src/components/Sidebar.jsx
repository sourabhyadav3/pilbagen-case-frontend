...
const NAV_BY_ROLE = {
  ...
  admin: [
    { section: 'Workspace' },
    { id: 'dashboard', label: 'Home', icon: 'dashboard', path: '/admin/dashboard' },
  ...
  partner: [
    { section: 'Workspace' },
    { id: 'p-dashboard', label: 'Home', icon: 'dashboard', path: '/partner/dashboard' },
    { id: 'p-clients', label: 'Clients', icon: 'clients', path: '/partner/clients' },
    { id: 'p-my-matters', label: 'Matters', icon: 'cases', path: '/partner/my-matters' },
    { id: 'p-billing', label: 'Time & Billing', icon: 'billing', path: '/partner/billing' },
    { id: 'p-conflict', label: 'Conflict Control', icon: 'leads', path: '/partner/conflict-check' },
  ...
  lawyer: [
    { section: 'Workspace' },
    { id: 'l-dashboard', label: 'Home', icon: 'dashboard', path: '/lawyer/dashboard' },
    { id: 'l-clients', label: 'Clients', icon: 'clients', path: '/lawyer/clients' },
    { id: 'l-cases', label: 'Matters', icon: 'cases', path: '/lawyer/matters' },
    { id: 'billing', label: 'Time & Billing', icon: 'billing', path: '/lawyer/billing' },
    { id: 'l-conflict', label: 'Conflict Control', icon: 'leads', path: '/lawyer/conflict-check' },
  ...
  paralegal: [
    { section: 'Workspace' },
    { id: 'pg-dashboard', label: 'Home', icon: 'dashboard', path: '/paralegal/dashboard' },
    { id: 'pg-clients', label: 'Clients', icon: 'clients', path: '/paralegal/clients' },
    { id: 'pg-my-matters', label: 'Matters', icon: 'cases', path: '/paralegal/my-matters' },
    { id: 'pg-billing', label: 'Time & Billing', icon: 'billing', path: '/paralegal/billing' },
